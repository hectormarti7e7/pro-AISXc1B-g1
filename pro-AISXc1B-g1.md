...
5. Creem les taules, per crear totes les taules he fet un script sql. ([script](scripts/create_tables.sql))
...
3. Creem l’script amb l’Event. ([script](scripts/create_event.sql))
4. Executem l’arxiu
