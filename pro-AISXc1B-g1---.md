...
8. Creem les taules, per crear totes les taules he fet un script sql. ([script](scripts/create_tables.sql))
...
2. Ara hem d’executar l’script ([script](scripts/Create_users.sh))
...
3. Creem l’script amb l’Event. ([script](scripts/create_events.sql))
4. Executem l’arxiu
